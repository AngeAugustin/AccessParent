...
export default function DetailsAccomp() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.avatarContainer}>
        ...
        <Text style={styles.nameText}><Text style={styles.boldText}>Sophie Martin</Text></Text>
        <Text style={styles.professionText}>Professeur</Text>
      ...
      <View style={styles.formContainer}>
        <ScrollView style={styles.form} showsVerticalScrollIndicator={false}>
          <Text style={styles.label}>Statut de l'accompagnement</Text>
          <View style={styles.inputReadonly}><Text style={styles.inputText}>Standard</Text></View>
